			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div style="position: relative; left: 40px;">
						...
						允许访问IP：<b><span style="width:200px;vertical-align:top;display:inline-block;overflow:hidden;text-overflow:ellipsis" title="${sessionScope.sessionUser.allowIps}">${sessionScope.sessionUser.allowIps}</span></b>
					</div>
				</div>
			...
			<ul>
				<li class="dropdown user-dropdown">
					<a href="javascript:void(0)" style="text-decoration: none; color: white;" class="dropdown-toggle" data-toggle="dropdown">
						<span class="glyphicon glyphicon-user"></span><span style="width:100px;display:inline-block"> &nbsp;&nbsp;&nbsp;&nbsp;${sessionScope.sessionUser.name} </span><span class="caret"></span>&nbsp;
					</a>
	...
	<div id="center" style="position: absolute;top: 50px; bottom: 30px; left: 0px; right: 0px;">
		...
		<div id="navigation" style="left: 0px; width: 18%; position: relative; height: 100%; overflow:auto;">
			...
			<ul id="no1" class="nav nav-pills nav-stacked">
				<li class="liClass"><a href="main/index.do" target="workareaFrame"><span class="glyphicon glyphicon-home"></span> 工作台</a></li>
				...
				<li class="liClass"><a href="activity/index.do" target="workareaFrame"><span class="glyphicon glyphicon-play-circle"></span> 市场活动</a></li>
